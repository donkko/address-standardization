...
class AddrStandardizer(object):
    ...
    def standardize(self, addr_str):
        ...
        for idx, split_addr in enumerate(split_addr_list_by_trie_addr):
            ...
            print "[addr_candidate_" + str(idx) + ']' + ' [depth]' + str(addr_candidate_tuple[0]) + ' [addr]' + addr_candidate_tuple[1]
...
if __name__ == '__main__':
    ...
    standardizer = AddrStandardizer()
    for addr in addr_list:
        standardizer.standardize(addr)
